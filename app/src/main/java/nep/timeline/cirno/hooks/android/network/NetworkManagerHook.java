...
public class NetworkManagerHook extends MethodHook {
    ...
    public String getTargetClass() {
        return (Build.VERSION.SDK_INT >= 36 ? "com.android.net.module.util.netlink.InetDiagMessage" : ((Build.VERSION.SDK_INT > Build.VERSION_CODES.TIRAMISU) ? "com.android.server.net.NetworkManagementService" : "com.android.server.NetworkManagementService"));
    }
